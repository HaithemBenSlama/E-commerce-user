...
export const ButtonFacebook = () => {
  return (
    <button className="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:bg-slate-200 hover:scale-110 hover:duration-300">
      <svg
