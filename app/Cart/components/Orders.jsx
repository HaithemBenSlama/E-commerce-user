    ...
    <div className="w-full md:w-4/12 lg:w-1/4">
      ...
      <div className="bg-slate-200 p-5 mx-5 md:mx-0 rounded-xl shadow-xl">
        <div className="pb-9 mb-7 text-center border-b border-black border-opacity-5">
          <h2 className="text-3xl leading-normal font-heading font-medium text-center">
            Order Summary
          </h2>
        </div>
        ...
        <a
          className="inline-block w-full py-5 lg:py-3 px-10 text-lg leading-6 lg:leading-7 text-white font-medium tracking-tighter font-heading text-center bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl"
          href="#"
        >
          Checkout
        </a>
